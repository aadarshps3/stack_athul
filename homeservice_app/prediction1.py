...
labels= {"Black soil":0,"Laterite soil":1,"Yellow soil":2}
## loading the saved model
model= load_model("soil.h5")

def model_predict1(new_scr):
    ...
    print(preds1)
    if preds1==0:
        preds1 = "The soil is Black Soil"
    elif preds1==1:
        preds1 = "The soil is Lateraite soil"
    elif preds1==2:
        preds1 = "It is a Yellow soil"
